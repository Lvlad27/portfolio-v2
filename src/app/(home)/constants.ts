export const HOME_PAGE = {
  ...
  section_1: {
    title: 'About',
    p1: `Back in 2021, guided by a a deep appreciation for design and problem-solving, I decided to steer more towards programming. I was hooked by the potential for creative expression through logic and critical thinking. Fast forward to today, I've had the opportunity to work for a globally widespread company on enterprise level applications.`,
